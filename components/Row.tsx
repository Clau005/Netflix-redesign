...
function Row({title, movies}: Props) {
  ...
  return (
    <div className="h-30 space-y-0.5 md:space-y-2">
        ...
        <div className="group relative md:-ml-2">
            <ChevronLeftIcon className={`absolute top-0 bottom-0 left-2 z-40 m-auto h-6 w-6 
            ...
            <ChevronRightIcon className={`absolute top-0 bottom-0 right-2 z-40 m-auto h-6 w-6 
